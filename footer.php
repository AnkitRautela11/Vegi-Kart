	...
	<div class="container">
		...
		<div class="col-md-3 footer-grid ">
			...
			<ul>
				...
				<li><a href="kitchen.php">Vegetables</a></li>
		...
		<div class="clearfix"></div>
			...
			<h1><a href="index.php"><img src="images/logo.png" alt="logo" width="350" height="95"></h1></a>
			<br>
			<h2><span style="color:yellow;">आपकी अपनी सब्जी मंडी</span></h2>
				...
				<div class=" address">
					...
					<div class="col-md-4 fo-grid1">
							<p><i class="fa fa-phone" aria-hidden="true"></i> +918433454131  </p>	
					</div>
					<div class="col-md-4 fo-grid1">
						<p><a href="mailto:info@example.com"><i class="fa fa-envelope-o" aria-hidden="true"></i> shop.vegikart@gmail.com </a></p>
					</div>
					<div class="clearfix"></div>
		...
		<div class="copy-right">
			<p> &copy; <a href="https://w3layouts.com/">2023</a> Vegikart. All Rights Reserved  </a></p>
		</div>
	</div>
</div>