<div class="nav-top">
                    ...
                    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                        <ul class="nav navbar-nav ">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu multi multi1">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 w3l">
                                            <a href="kitchen.php"><img src="images/logo.jpg" class="img-responsive" alt=""></a>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>  
                                </ul>
                            ...
                            <a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span> Groceries <b class="caret"></b></span></a>
                            <ul class="dropdown-menu multi multi1">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <ul class="multi-column-dropdown">
